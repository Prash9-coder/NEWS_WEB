            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                >
                    <h1 className="text-5xl md:text-6xl font-black mb-6">
                        About <span className="gradient-text">NewsHub</span>
                    </h1>
                ...
                >
                    ...
                    <p className="text-gray-700 text-lg leading-relaxed mb-4">
                        At NewsHub, we believe in the power of journalism to inform, inspire, and create positive change. Our mission is to deliver accurate, unbiased, and timely news coverage that empowers our readers to make informed decisions.
                    </p>
