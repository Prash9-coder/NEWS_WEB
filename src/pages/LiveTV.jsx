...
import { Tv, Play, Volume2, Maximize2, Share2, Radio } from 'lucide-react';
...
const LiveTV = () => {
    ...
    const channels = [
        ...
        },
        {
            id: 2,
            name: 'NewsHub Hindi',
            streamUrl: 'https://www.youtube.com/embed/K1O1yaOTq8o?autoplay=1',
            logo: '🇮🇳'
        },
        {
            id: 3,
            name: 'NewsHub Business',
            streamUrl: 'https://www.youtube.com/embed/F-HP3LKRGXI?autoplay=1',
            logo: '📈'
        },
        {
            id: 4,
            name: 'NewsHub Sports',
            streamUrl: 'https://www.youtube.com/embed/mCdA4bJAGGk?autoplay=1',
            logo: '⚽'
        },
    ];
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 mt-[60px]">
                    ...
                    <div className="lg:col-span-8">
                        ...
                        >
                            ...
                            <p className="text-gray-400 mt-2">Watch live news coverage 24/7</p>
                        </motion.div>
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                                {channels.map((channel, index) => (
                                    <motion.button
                                        ...
                                        className={`p-4 rounded-lg font-semibold text-sm transition-all ${activeChannel === index
                                            ? 'bg-primary text-white shadow-lg shadow-primary/30'
                                            : 'bg-gray-700 text-gray-300 hover:bg-gray-600'
                                            }`}
                                    >
                                        <span className="text-2xl block mb-1">{channel.logo}</span>
                                        {channel.name}
                                        {activeChannel === index && (
                                            <span className="block text-xs mt-1 flex items-center justify-center">
                            ...
                            <div className="grid md:grid-cols-2 gap-2 max-h-96 overflow-y-auto">
                                {schedule.map((item, index) => (
                                    <motion.div
                                        ...
                                        className={`flex items-center p-3 rounded-lg ${item.current
                                    ...
                                    >
                                        ...
                                        {item.current && (
                                            <span className="bg-white text-primary text-xs px-2 py-1 rounded font-bold flex items-center">
                        ...
                        <div className="sticky top-36 space-y-6 mt-[90px]">
                            ...
                            <div className="bg-gray-800 rounded-lg p-6">
                                ...
                                <div className="space-y-3">
                                    {[
                                        { name: 'NewsHub Regional', viewers: '125K' },
                                        { name: 'NewsHub Entertainment', viewers: '89K' },
                                        { name: 'NewsHub World', viewers: '67K' },
                                    ].map((ch, index) => (
                                        <div
                                            key={index}
