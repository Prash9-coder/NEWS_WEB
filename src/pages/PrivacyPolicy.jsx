...
const PrivacyPolicy = () => {
    const sections = [
        ...
        },
        {
            icon: FileText,
            title: 'Your Rights',
            content: `You have the right to access, update, or delete your personal information at any time. You can also opt out of receiving marketing communications from us. If you have any questions about your data, please contact us at privacy@newshub.com.`
        }
    ];
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                >
                    <p className="text-gray-700 leading-relaxed mb-6">
                        At NewsHub, we take your privacy seriously. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website. Please read this privacy policy carefully.
                    </p>
                ...
                >
                    ...
                    <ul className="space-y-2">
                        <li>Email: privacy@newshub.com</li>
