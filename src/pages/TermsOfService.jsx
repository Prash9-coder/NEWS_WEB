            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                >
                    ...
                    <p className="text-gray-700 leading-relaxed mb-4">
                        These Terms of Service constitute a legally binding agreement made between you and NewsHub Media Pvt. Ltd. concerning your access to and use of the NewsHub website.
                    </p>
                ...
                >
                    ...
                    <p className="text-gray-700 leading-relaxed mb-4">
                        All content on this website, including but not limited to text, graphics, logos, images, videos, and software, is the property of NewsHub Media Pvt. Ltd. and is protected by international copyright and trademark laws.
                    </p>
                    <p className="text-gray-700 leading-relaxed">
                        You may not reproduce, distribute, modify, create derivative works of, publicly display, or exploit for commercial purposes any of the content without prior written consent from NewsHub.
                    </p>
                </motion.div>
